  ...
  Widget build(BuildContext context) {
    ...
    return StatefulBuilder(
      builder: (context, setState) {
        // Filter out restaurants without photos before building GridView
        final restaurantsWithPhotos = filteredRestaurants.where((restaurant) {
          return restaurant['photos'] != null &&
              restaurant['photos'].isNotEmpty &&
              restaurant['photos'][0]['photo_reference'] != null;
        }).toList();
              ...
              children: [
                ...
                (restaurantsWithPhotos.isEmpty)
                    ...
                    : GridView.builder(
                        ...
                        itemCount: restaurantsWithPhotos.length,
                        gridDelegate:
              ...
              (filteredRestaurants.isEmpty)
                  ...
                  : GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        (photoReference == null || photoUrl == null)
